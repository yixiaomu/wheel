...
from wheel.utils.shorturl import ShorterURL
from wheel.utils.settings import get_setting_value, get_site_url
from wheel.core.models.channel import Channeling
from wheel.core.models.custom_values import HasCustomValue
from wheel.core.models.subcontent import SubContent
from wheel.core.models.signature import Tagged
from wheel.core.models.signature import Publishable
from wheel.core.models.signature import LongSlugged
from wheel.core.models.signature import ContentFormat
from wheel.core.models.signature import TemplateType
...
class Content(HasCustomValue, Publishable, LongSlugged,
    ...
    def get_main_image_url(self, thumb=False,
        ...
        for item in identifier:
            try:
                ...
                return url_for('wheel.core.media', filename=path)
    ...
    def get_absolute_url(self, endpoint='wheel.core.detail'):
    ...
    def module_name(self):
        ...
        module_name = module.replace('wheel.modules.', '').split('.')[0]
        return module_name
